...
const CaloriesScreen = () => {
  ...
  const fetchTodaysCalories = async () => {
    try {
      const response = await fetch(`https://fd0a-46-97-171-30.ngrok-free.app/todaysCalories?userId=${userId}`);
  ...
  const fetchWeeklyCalories = async () => {
    try {
      const response = await fetch(`https://fd0a-46-97-171-30.ngrok-free.app/weeklyCalories?userId=${userId}`);
      const data = await response.json();
  ...
  const addFoodCalories = async () => {
    ...
    try {
      const response = await fetch('https://fd0a-46-97-171-30.ngrok-free.app/incrementFoodCalories', {
        method: 'POST',
